...
#OpenAI API key
aienv = os.getenv('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')
if aienv == None:
    openai.api_key = "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"
else:
    openai.api_key = aienv
print(aienv)

#Telegram bot key
tgenv = os.getenv('6115050967:AAGwSpGcmUcV6ehKJGLK4Vbm6Rl9X1i-PbA')
if tgenv == None:
    tgkey = "6115050967:AAGwSpGcmUcV6ehKJGLK4Vbm6Rl9X1i-PbA"
else:
    tgkey = tgenv
print(tgenv)
